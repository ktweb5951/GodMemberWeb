...
SET DEFINE OFF;
Insert into MALLMEMBER.FREEBOARD_TBL (FREEBOARD_NO,FREEBOARD_TITLE,FREEBOARD_CONTENT,FREEBOARD_WRITER,VIEW_COUNT,RCMND_COUNT,FREEBOARD_DATE,UPDATE_DATE) values (3,'나 대황현우야','모두 꿇어','khuser01',0,0,to_timestamp('23/08/07 10:21:44.984000000','RR/MM/DD HH24:MI:SSXFF'),to_timestamp('23/08/07 10:21:44.984000000','RR/MM/DD HH24:MI:SSXFF'));
